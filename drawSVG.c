...
void drawEdges(svgEdge* edgeList, svg* nodeList, FILE* fd){
    ...
    svg* currentNode;
    double sizenfrom, xnfrom, ynfrom, sizento, xnto, ynto;
    double lengthedge;
